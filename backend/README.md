...
## Project Structure
    ...
    ├── testapiautoteammemb_62215  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_62215`
...
2. Clone this repo and `cd testapiautoteammemb_62215`
